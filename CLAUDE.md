...
For a new project, run `python3 scripts/new_project.py <slug>` when shell access is available. Validate this skill library with `python3 scripts/validate_skills.py`.
