---
name: 10-shotlist
description: Converts a scene or whole script into a connected production shotlist with shot IDs, timing, purpose, framing, camera, blocking, continuity dependencies, assets, prompt payload, sound, transition, and acceptance criteria.
version: 0.1.0
stage: production
---
...
## Trigger
Use this skill whenever the request materially involves shotlist director in an AI film, commercial, trailer, music video, branded short, or narrative video workflow.
...
## Shot contract
Every row must contain: Shot ID, scene, runtime, dramatic purpose, shot size, camera/FOV intent, camera move, blocking, action beat, performance beat, INHERIT, CHANGE, MUST_NOT_CHANGE, reference IDs, generation prompt ID, sound cue, transition, acceptance criteria, fallback/pickup option.

A beautiful shot with no edit function is rejected. A shot whose continuity state cannot be stated is not ready to generate.
