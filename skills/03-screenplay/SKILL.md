---
name: 03-screenplay
description: Writes and revises screenplays for image-to-video and text-to-video production, balancing dramatic clarity with generatability, continuity, dialogue economy, and shot feasibility.
version: 0.1.0
stage: development
---
...
## Trigger
Use this skill whenever the request materially involves screenplay architect in an AI film, commercial, trailer, music video, branded short, or narrative video workflow.
