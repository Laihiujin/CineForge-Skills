---
name: 11-continuity
description: Tracks identity, wardrobe, props, screen direction, eyelines, geography, lighting, weather, injuries, object state, temporal state, and last-frame/first-frame bridges across every shot.
version: 0.1.0
stage: production
---
...
## Trigger
Use this skill whenever the request materially involves continuity supervisor in an AI film, commercial, trailer, music video, branded short, or narrative video workflow.
...
## Continuity ledger
For each shot compare the planned start state with the previous accepted end state. Flag contradictions in identity, wardrobe, props, axis, eyeline, geography, time, weather, injuries, dirt/wetness, lighting sources, performance energy, and audio space.

Return severity: BLOCKER / MAJOR / MINOR / NOTE. Provide the cheapest valid fix: prompt revision, reference replacement, shot reorder, bridge shot, insert, crop, edit concealment, or regeneration.
