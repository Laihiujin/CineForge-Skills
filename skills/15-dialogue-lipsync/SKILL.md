---
name: 15-dialogue-lipsync
description: Prepares dialogue for generated performance: line timing, phonetic risk, breath, pauses, mouth visibility, speaking order, overlap policy, reaction beats, and sync-friendly camera coverage.
version: 0.1.0
stage: generation
---

# Dialogue & Lip-Sync Director

## Trigger
Use this skill whenever the request materially involves dialogue & lip-sync director in an AI film, commercial, trailer, music video, branded short, or narrative video workflow.
