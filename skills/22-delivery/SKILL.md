---
name: 22-delivery
description: Prepares technical masters and platform variants with codec, resolution, frame rate, audio loudness, captions, safe areas, naming, checksum, archive, and handoff metadata.
version: 0.1.0
stage: quality
---
...
## Trigger
Use this skill whenever the request materially involves mastering & delivery in an AI film, commercial, trailer, music video, branded short, or narrative video workflow.
