---
name: 07-visual-language
description: Defines the film-wide image grammar: aspect ratio, composition, lens families, camera behavior, lighting logic, palette, texture, contrast, filtration, grain, production design, and style exclusions.
version: 0.1.0
stage: preproduction
---

# Visual Language Director

## Trigger
Use this skill whenever the request materially involves visual language director in an AI film, commercial, trailer, music video, branded short, or narrative video workflow.
