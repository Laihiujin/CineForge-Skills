---
name: 18-music
description: Creates a music brief and edit map: emotional arc, tempo zones, motif strategy, instrumentation, structure, hit points, transitions, stems, ducking, and licensing/usage notes.
version: 0.1.0
stage: post
---
...
## Trigger
Use this skill whenever the request materially involves music supervisor in an AI film, commercial, trailer, music video, branded short, or narrative video workflow.
