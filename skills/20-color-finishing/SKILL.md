---
name: 20-color-finishing
description: Defines shot matching, exposure normalization, white-balance continuity, contrast curve, palette protection, skin handling, grain/noise consistency, sharpening restraint, and final look QC.
version: 0.1.0
stage: post
---

# Color & Finishing Supervisor

## Trigger
Use this skill whenever the request materially involves color & finishing supervisor in an AI film, commercial, trailer, music video, branded short, or narrative video workflow.
