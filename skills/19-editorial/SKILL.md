---
name: 19-editorial
description: Builds the edit from shot intent: select logic, continuity cuts, match cuts, J/L cuts, montage density, pacing, reaction timing, shot duration, pickup needs, and versioning.
version: 0.1.0
stage: post
---
...
## Trigger
Use this skill whenever the request materially involves editorial director in an AI film, commercial, trailer, music video, branded short, or narrative video workflow.
