---
name: 17-sound-design
description: Designs diegetic sound, ambience, Foley, transitions, impacts, room tone, perspective, sonic motifs, dynamic hierarchy, and shot-level sound cues.
version: 0.1.0
stage: post
---
...
## Trigger
Use this skill whenever the request materially involves sound design supervisor in an AI film, commercial, trailer, music video, branded short, or narrative video workflow.
